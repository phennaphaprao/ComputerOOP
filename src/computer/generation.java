...
abstract class generation {
    ...
    public void ASUS(){
        ...
        System.out.println("price is "+Asus1+" THB");
        }else if(asus==2){
        ...
        System.out.println("price is "+Asus2+" THB");
        }else if(asus==3){
        System.out.println("1. AMD FX-9830P (3.00 GHz) \n"+ 
                           ...
                           "4. 1 TB 5400 RPM\n"+
                           "5. 15.6 inch (1366x768) HD");
        System.out.println("price is "+Asus3+" THB");
        }else if(asus==4){
        ...
        System.out.println("price is "+Asus4+" THB");
        }
        System.out.println("-----------------------------------------------------");
    }
    ...
    public void ACER(){
        ...
        System.out.println("price is "+Acer1+" THB");
        }else if(asus==2){
        System.out.println("1. Intel Core i3-4005U (1.70 GHz)\n"+ 
                           ...
                           "4. 500 GB 5400 RPM\n"+
                           "5. 15.6 inch (1366x768) HD");
        System.out.println("price is "+Acer2+" THB");
        }else if(asus==3){
        System.out.println("1. Intel Core i5-5200U (2.20 GHz) \n"+ 
                           ...
                           "4. 500 GB 5400 RPM\n"+
                           "5. 15.6 inch (1366x768) HD");
        System.out.println("price is "+Acer3+" THB");
        }else if(asus==4){
        ...
        System.out.println("price is "+Acer4+" THB");
        }
         System.out.println("-----------------------------------------------------");
    }
    ...
    public void DELL(){
        ...
        System.out.println("1. Celeron Dual Core\n" +
                           ...
                           "5. 1366x768");
        System.out.println("price is "+Dell1+" THB");
        }else if(asus==2){
        ...
        System.out.println("price is "+Dell2+" THB");
        }else if(asus==3){
        ...
        System.out.println("price is "+Dell3+" THB");
        }else if(asus==4){
        System.out.println("1. 16GB (2x 8192MB) – DDR3, 1600Mhz \n"+ 
                           ...
                           "5. 4 MB");
        System.out.println("price is "+Dell4+" THB");
        }
         System.out.println("-----------------------------------------------------");
    }
    ...
    public void MSI(){
        ...
        System.out.println("price is "+Msi1+" THB");
        }else if(asus==2){
        ...
        System.out.println("price is "+Msi2+" THB");
        }else if(asus==3){
        System.out.println("1. Intel Core i7-7700HQ (2.80 - 3.80 GHz) \n"+ 
                           "2. NVIDIA GeForce GTX 1050 (2GB GDDR5)\n"+
                           "3. 8 GB DDR4\n"+
        ...
        System.out.println("price is "+Msi3+" THB");
        }else if(asus==4){
        System.out.println("1. Up to 7th Gen. Intel® Core™ i7 processo\n"+ 
                           ...
                           "4. DDR4-2400\n"+
                           "5. Max 32GB");
        System.out.println("price is "+Msi4+" THB");
        }
         System.out.println("-----------------------------------------------------");
    }
